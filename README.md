...
1. Explain the difference between `RDBMS` and `SQL`.
 ...
 RDMS are specialized software that manages databases.
 SDL is a standard language used to manage databases and data in it.

1. Why do tables need a `primary key`?

  PK uniquely identifies each record in the table.
...
1. What do we need in order to have a _many to many_ relationship between two tables.
  ...
  a third table to define the relationships (bridge table)
